...
Some parts of the documentation of a module describe high-level design choices or principles and do not correspond to a single declaration.
For this use case we support *notes*: toplevel declarations with a name to which we can attach textual documentation.
...
Notes are preserved during program transformations and are part of the browsable documentation generated by the `pol doc` subcommand.
